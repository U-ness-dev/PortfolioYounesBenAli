...
export const projects: Project[] = [
  {
    slug: 'atelier-nord',
    title: 'Atelier Nord',
    subtitle: 'Identity for an architecture studio',
    year: '2025',
    role: 'Brand identity · Art direction',
    disciplines: ['Branding', 'Graphic design'],
    tools: ['Illustrator', 'InDesign'],
    summary: 'A visual system for a studio that builds with light, shadow and plain materials.',
    statement:
      'Atelier Nord designs quiet buildings. The identity follows the work — a restrained system of rules, generous white space and one warm accent, applied from business cards to construction-site signage.',
    media: [{ type: 'image', src: '/images/work/plate-01.svg', alt: 'Atelier Nord — identity system' }],
    chapters: [
      {
        title: 'Context',
        ...
        media: [{ type: 'image', src: '/images/work/plate-01.svg', alt: 'Atelier Nord — grid studies' }],
      },
      {
        title: 'Concept',
        body: 'A modular grid borrowed from architectural drafting. Everything aligns to it, and the single brass accent reads as a beam of light falling across a floor plan.',
      },
      {
        title: 'Process',
        ...
        media: [{ type: 'image', src: '/images/work/plate-01.svg', alt: 'Atelier Nord — stationery' }],
      },
      {
        title: 'Outcome',
        body: 'A system the team actually uses. The identity holds up at two centimetres on a screen and two metres on a hoarding, which was the measure that mattered.',
      },
    ],
  },
  {
    ...
    summary: 'A digital publication that treats listening as a spatial act — each issue is a room.',
    statement:
    ...
    media: [{ type: 'image', src: '/images/work/plate-02.svg', alt: 'Cantata — issue environment' }],
    chapters: [
      {
        title: 'Context',
      ...
      },
      {
        ...
        media: [{ type: 'image', src: '/images/work/plate-02.svg', alt: 'Cantata — typography studies' }],
      },
      {
        title: 'Process',
  ...
  },
  {
    ...
    summary: 'A mobile companion for a Paris gallery quarter that works one-handed and outside.',
    statement:
    ...
    media: [{ type: 'image', src: '/images/work/plate-03.svg', alt: 'Marais — mobile interface' }],
    chapters: [
      {
        title: 'Context',
      ...
      },
      {
        ...
        media: [{ type: 'image', src: '/images/work/plate-03.svg', alt: 'Marais — interface studies' }],
      },
      {
        title: 'Process',
  ...
  },
  {
    ...
    summary: 'A campaign that photographs the weight, grain and fall of raw stone.',
    statement:
    ...
    media: [{ type: 'image', src: '/images/work/plate-04.svg', alt: 'Terrain — stone studies' }],
    chapters: [
      {
        title: 'Context',
      ...
      },
      {
        ...
        media: [{ type: 'image', src: '/images/work/plate-04.svg', alt: 'Terrain — render studies' }],
      },
      {
        title: 'Process',
  ...
  },
  {
    ...
    summary: 'A cover system where every book is a variant of the same set of rules.',
    statement:
    ...
    media: [{ type: 'image', src: '/images/work/plate-05.svg', alt: 'Éditions Lumen — cover system' }],
    chapters: [
      {
        title: 'Context',
      ...
      },
      {
        ...
        media: [{ type: 'image', src: '/images/work/plate-05.svg', alt: 'Éditions Lumen — typography' }],
      },
      {
        title: 'Process',
  ...
  },
  {
    ...
    summary: 'A generative installation that turns city signals into a slow visual score.',
    statement:
    ...
    media: [{ type: 'image', src: '/images/work/plate-06.svg', alt: 'Signaux — installation' }],
    chapters: [
      {
        title: 'Context',
      ...
      },
      {
        ...
        media: [{ type: 'image', src: '/images/work/plate-06.svg', alt: 'Signaux — composition studies' }],
      },
      {
        title: 'Process',
